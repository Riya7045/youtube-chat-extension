...
def generate_answer(input_dict: dict) -> str:
    ...
    input_dict keys:
      ...
      - 'vidDetails' : Contains youtube transcript along with other video details
    ...
    # Step 1a: Document Ingestion (Get Video Details (transcript and other details))
    vidDetails = input_dict['vidDetails']
    if not vidDetails:
        return "No transcript available for this video."

    # Step 1b: Text splitting
    splitter = RecursiveCharacterTextSplitter(chunk_size=1000, chunk_overlap=200)
    chunks = splitter.create_documents([vidDetails])
...
DO NOT MENTION THE TERM "TRANSCRIPT" OR LIKE THAT IN YOUR RESPONSE, GIVE RESPONSE AS IF YOU HAVE WATCHED THE VIDEO
Context: {context}
QuerySo: {question}
""",
